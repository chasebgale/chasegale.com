(function ($) {
    ...
    fetch("https://chasegale.com/contributions.php", {
        ...
        contributionsSVG.setAttribute("width", "100%");

        // Would love to nest scale()/min()/calc() but CSS and SVG don't play nice
        contributionsDOM.style.setProperty("--scale", Math.min(0.75, document.body.clientWidth / 750));
